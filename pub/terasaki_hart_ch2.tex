...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO:
%1. rewrite discussion
%2. revisit methods
%3. use 'upslope' or 'up-gradient'?
%4. add in stats test results
%5. write any final stats tests? (pheno-shift ANOVA using redund and non-redund combined? test for directions?)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(i.e., that they result in greater reductions in population size and mean fitness
...
As expected, up-gradient gene flow was always higher under climate change than in equivalent null simulations (\ref{fig:fig_2}).
(Conversely, maladaptive downslope gene flow was also supressed under climate change.)
However, contrary to out expectation we found that the amount of upslope gene flow
was negatively correlated with the level of linkage.
Polygenicity had the strongest overall effect on the amount that upslope gene flow contributes to adaptation:
with the exception of the low-redundancy, independent-linkage scenarios,
moderate and high polygenicity scenarios had much lower upslope gene flow
...
The strength of demographic responses to climate change was positively
...
%TODO:
        %1. RECONSIDER PARAGRAPHS BELOW (NEED 1 PAR PER HYPOTH? CAN I FOLD THE APPARENT CONTRADICTIONS INTO THE HYPOTH PARS?)
        %2. CONDENSE AND REDRAFT PAR BY PAR

p1        - H1 DIS: (below)
Our analysis provides important theoretical insights
into the nature of polygenic adaptation under multivariate environmental change,
highlighting a neglected area of research and contributing to the conversation
about biodiversity management under climate change.

Overall, the gene flow results from our complex simulations
support the common conceptual model 
in which adaptation to climate change occurs by way
of gene flow following shifting climatic gradients.
This result is important because that conceptual model
is rarely questioned or tested, yet it 
typically assumes a univariate selective environment and
simple genomic architectures -- unrealistic conditions for
many of the real-world systems whose management practices
(e.g., assisted gene flow; \cite{aitken_whitlock}) it often informs.

[COMBINE NEXT 2 PARAGRAPHS, THEN TACK ONTO PARAGRAPH 1]
Our results lend generalized support to the foundational logic of AGF.
...
generalized $n$ traits adapted to $\leq n$ gradients.
...
p5      future diretions, including:
        ...
        - other dimensions to explore (include list below; also mention hybridization?? see recent opinion cited in Science?)
