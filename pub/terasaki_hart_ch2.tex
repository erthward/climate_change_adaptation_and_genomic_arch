...
In nature, species are simultaneously adapted to a variety of environmental gradients. When climate change causes these gradients to shift at different rates and in different directions, populations experience novel selective pressures. Understanding how species respond to these new conditions is essential for preserving biodiversity under climate change. Here, we use spatially-explicit, individual-based simulations to examine how genomic architecture can influence the efficacy of gene flow and adaptation for species persistence under multivariate environmental change. Our analyses reveal that linkage, polygenicity, and genotypic redundancy all contribute to determining the effectiveness of adaptation and the relative contributions of climate-tracking gene flow and \textit{in situ} selection to that adaptation. These findings provide new insights into how genomic architecture influences evolutionary responses to climate change.
}
