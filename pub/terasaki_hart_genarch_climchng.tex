...
continuously distributed on a two-dimensional landscape described by two different environmental
...
and even scenarios in which two or more traits vary in the
simplicity/complexity of their genomic architectures --- a realistic
arrangement that could demonstrate important differences
to the evolutionary outcomes we describe here.
...
genomic architecture can play an important, but largely overlooked, role in determining the relative effectiveness
...
whether, wherhe, and how species may adapt to climate change.
