...
\begin{figure*}
\centering
\includegraphics[width=.8\linewidth]{pub/figs_and_stats/FIG_S3_density_shift.png}
...
\begin{figure*}
\centering
\includegraphics[width=.8\linewidth]{pub/figs_and_stats/FIG_S4_phenotypic_shift_null.png}
